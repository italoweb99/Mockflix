      ...
      <div ref={ref} className="bg-bgpurple/80 backdrop-blur-sm hover:text-gray-300 text-gray-200  overflow-auto flex flex-col mx-20 h-[500px] rounded-b-xl" >
       {
        filmeList.length > 0?(
        filmeList.map(filme =>(
            <div onClick={()=>clickHandle(filme.id)} className="flex items-center my-1 transition-all ease-out duration-300 mx-3 cursor-pointer hover:bg-bgpurplehover/80 rounded-lg"  >
